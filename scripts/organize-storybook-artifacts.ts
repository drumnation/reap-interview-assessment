/**
 * Post-Storybook E2E script: organizes test artifacts with story-based filenames
 * and generates docs/STORYBOOK-RESULTS.md with linked screenshots and videos.
 *
 * Usage: tsx scripts/organize-storybook-artifacts.ts
 */
import fs from 'fs';
